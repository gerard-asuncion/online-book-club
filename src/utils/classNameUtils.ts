...
export const highlightBookRoomCard = (openBookRoom: string, bookRoomName: string): string => 
    ...
    ? "bg-gray-900 border-2 border-green-800 text-green-800 transition-colors duration-400 md:duration-100 ease-in-out md:hover:bg-green-800 md:hover:text-white"
